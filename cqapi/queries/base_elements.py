...
class QueryObject:
    ...
    def translate(self, concepts: dict, removed_ids: ConqueryIdCollection, children_ids: List[ChildId, ConceptId]) -> \
...
class AndOrElement(QueryObject):
    ...
    def translate_children(self, concepts: dict, removed_ids: ConqueryIdCollection, children_ids: List[ChildId, ConceptId]):
        children = list()
        new_children = list()
...
class ConceptElement(QueryObject):
    ...
    def translate(self, concepts: dict, removed_ids: ConqueryIdCollection,
                  children_ids: List[ChildId, ConceptId]) -> Tuple[Union[ConceptElement, None], Union[ConceptElement, None]]:
        """
...
class SimpleQuery(QueryObject):
    ...
    def translate(self, concepts: dict, removed_ids: ConqueryIdCollection, children_ids: List[ConceptId, ChildId]) -> \
            Tuple[Union[QueryObject, None], Union[QueryObject, None]]:
        raise NotImplementedError
